...
class CorrectionConcept(str, Enum):
    """Concepto de corrección en nota crédito."""
    PARTIAL_RETURN = "partial_return"          # Devolución parcial
    CANCELLATION = "cancellation"              # Anulación de factura
    DISCOUNT = "discount"                      # Rebaja o descuento
